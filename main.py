...
x = tf.keras.layers.Flatten()(x) # https://stackoverflow.com/questions/70326871/shape-error-while-fine-tuning-mobilenet-on-a-custom-data-set
# x = tf.keras.layers.Reshape(target_shape=(1024,))(x) #toto nemala vo videu
